...
mtcars %>% 
  ...
  labs(x = "Cilindros",        
       y = "Milhas por galão",
    title = "Milhas por galão x Cilindros")+
  theme(plot.title = element_text(hjust = 0.5))
```
...
Interpretação: Idealmente, você quer ver os pontos dispersos aleatoriamente em torno da linha horizontal em y = 0, sem padrões discerníveis. Isso indicaria que o modelo é apropriado e não há erros sistemáticos.
